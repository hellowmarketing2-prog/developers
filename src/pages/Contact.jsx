...
import "./Contact1.css"; // your custom CSS for contact page
...
function Contact() {
  ...
  // Handle form submission using Web3Forms (No setup needed!)
  const handleSubmit = async (e) => {
    ...
    formData.append("access_key", "8dd5cbbd-e943-4e80-8cd9-eafda035deaa");
    ...
    try {
      ...
      setFormStatus({
        type: 'error',
        message: '❌ Failed to send message. Please try again or email me directly at umaraidevs@gmail.com'
      });
    } finally {
          ...
          <div className="contact-content">
            ...
            <div className="contact-form-container" data-aos="fade-left">
              ...
              <form className="contact-form" id="contactForm" onSubmit={handleSubmit}>
                ...
                <input type="hidden" name="email_to" value="umaraidevs@gmail.com" />
        ...
        <div className="container">
          <div className="cta-content" data-aos="fade-up">
            ...
            <div className="cta-buttons">
              <a href="#contactForm" className="btn btn-primary">Send Message</a>
              <a href="projects.html" className="btn btn-outline">View My Work</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              <h3>Portfolio</h3>
              <p style={{ color: "white" }}>Creating amazing digital experiences with passion and dedication.</p>
              <div className="footer-social">
                ...
                <a style={{ color: "white" }} href="https://www.facebook.com/profile.php?id=61585355743404" aria-label="Facebook">
            ...
            <div className="footer-section">
              ...
              <ul>
                ...
                <li style={{ color: "white" }}><a href="about.html">About</a></li>
                <li style={{ color: "white" }}><a href="skills.html">Skills</a></li>
                <li style={{ color: "white" }}><a href="projects.html">Projects</a></li>
                <li style={{ color: "white" }}><a href="contact.html">Contact</a></li>
              </ul>
            </div>
            <div className="footer-section">
              <h4 style={{ color: "white" }}>Contact Info</h4>
              <div className="contact-info">
                <p style={{ color: "white" }}><i className="fas fa-envelope"></i> umaraidevs@gmail.com</p>
                <p><i className="fas fa-phone"></i> +92 0303 3418886</p>
                <p style={{ color: "white" }}><i className="fas fa-map-marker-alt"></i> FAISALABAD, PAKISTAN</p>
              </div>
            </div>
          </div>
